...
pub use secrets::{PlatformSecretStore, SecretStore, SECRET_DATABASE_URL, SECRET_DEEPSEEK_API_KEY};
...
pub fn update_user_settings(
  ...
  let event = state.service.changed_event(
    &before,
    &result.settings,
    result.restart_services.clone(),
  );
